...
public class ShootingEntityGrenade extends EntityLiving implements
	IRangedAttackMob {
	...
	if (stack != null) {
	    GrenadeProjectile entityCrap = new GrenadeProjectile(worldObj,
		    posX, posY + 1.5F, posZ);
	    ...
	    entityCrap.setThrowableHeading(d0, d1 + (double) f1, d2, 1.5F,
		    accuracy);
	    worldObj.playSoundEffect(posX, posY, posZ,
		    "modularturrets:grenade", 1.0F, 1.0F);
