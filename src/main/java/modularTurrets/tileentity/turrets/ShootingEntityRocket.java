...
public class ShootingEntityRocket extends EntityLiving implements IRangedAttackMob {
    ItemStack stack;

    public ShootingEntityRocket(World par1World) {
	    super(par1World);
    }
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase entitylivingbase, float f, float accuraccy, TurretBase base) {
        ...
        if (stack != null) {
            RocketProjectile entityCrap = new RocketProjectile(worldObj, posX, posY + 1.5F, posZ, entitylivingbase);
            ...
            double d1 = entitylivingbase.posY + (double) entitylivingbase.getEyeHeight() - 2.500000023841858D - this.posY;
