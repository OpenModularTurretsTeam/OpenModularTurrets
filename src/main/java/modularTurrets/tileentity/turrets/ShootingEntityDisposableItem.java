...
public class ShootingEntityDisposableItem extends EntityLiving implements IRangedAttackMob {
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase entitylivingbase, float f, float accuraccy, TurretBase base) {
        if (stack != null) {
            ...
            double d1 = entitylivingbase.posY + (double) entitylivingbase.getEyeHeight() - 2.5F - this.posY;
