...
public class Recipes {
    ...
    public static void initRecipes() {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.turretBaseTierWood,
            new Object[] { "ADA", "DCD", "ADA", 'A', net.minecraft.init.Blocks.planks, 'D',
                net.minecraft.init.Items.iron_ingot, 'C', net.minecraft.init.Items.redstone }));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.sensorTierFourItem,
            new Object[] { "ADA", "DCD", "ADA", 'A', "ingotEnderium", 'D',
                    net.minecraft.init.Items.diamond, 'C', net.minecraft.init.Blocks.redstone_block }));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.fireRateUpgradeItem,
            new Object[] { "   ", "DCD", "ADA", 'A', "dustElectrum", 'D',
                    net.minecraft.init.Items.blaze_powder, 'C', net.minecraft.init.Items.diamond }));
    
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.efficiencyUpgradeItem,
            new Object[] { "   ", "DCD", "ADA", 'A', "dustElectrum", 'D',
                    net.minecraft.init.Items.ender_pearl, 'C', net.minecraft.init.Items.diamond }));
    
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.rangeUpgradeItem,
            new Object[] { "   ", "BCB", "ADA", 'A', "dustElectrum", 'D',
                    net.minecraft.init.Items.emerald, 'C', net.minecraft.init.Items.diamond }));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.solarPanelAddon,
            new Object[] { "BBB", "DDD", "ACA", 'A',
                "dustElectrum", 'D', net.minecraft.init.Blocks.lapis_block, 'C',
                    net.minecraft.init.Items.redstone, 'B', net.minecraft.init.Blocks.glass }));
    
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.redstoneReactorAddon,
            new Object[] { "DDD", "DCD", "DAD", 'A', net.minecraft.init.Items.redstone, 'D',
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.damageAmpAddon,
            new Object[] { "   ", "CCC", "ADA", 'A', "ingotElectrum", 'D',
                "ingotElectrum", 'C', net.minecraft.init.Items.diamond }));
    
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.barrel,
                new Object[] {
            "CCC", "   ", "CCC", 'C', "ingotInvar" }));
    
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.chamber,
                new Object[] {
            "CCC", "  C", "CCC", 'C', "ingotInvar" }));

        GameRegistry.addRecipe(new ShapedOreRecipe(Items.ioBus,
                new Object[] { " A ", "BBB", " A ", 'A', net.minecraft.init.Items.gold_ingot, 'B',
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.containmentChamber,
            new Object[] { "CCC", "DBC", "CCC", 'C', "ingotInvar", 'D',
                net.minecraft.init.Items.diamond, 'B', "ingotPlatinum" }));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.leverBlock,
            new Object[] { "CCC", "C  ", "C  ", 'C', net.minecraft.init.Blocks.stone }));
    
        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.disposableItemTurret,
            new Object[] { "BCB", "CAC", " C ", 'C', net.minecraft.init.Items.iron_ingot, 'B',
                    net.minecraft.init.Blocks.planks, 'A', net.minecraft.init.Blocks.dispenser }));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.grenadeLauncherTurret, new Object[] { "DBD", "BAB",
                " C ", 'C', Items.barrel, 'B', "ingotInvar", 'A',
                Items.chamber, 'D', "dustLead" }));
    
        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.rocketTurret,
        ...
        GameRegistry.addRecipe(new ItemStack(Items.bulletCraftable, 32),
            new Object[] { " B ", " A ", " A ", 'B', net.minecraft.init.Items.iron_ingot, 'A',
                    net.minecraft.init.Items.gunpowder });
    
        GameRegistry.addRecipe(new ItemStack(Items.rocketCraftable, 16),
            new Object[] { " A ", "ABA", "ABA", 'A', net.minecraft.init.Items.iron_ingot, 'B',
                    net.minecraft.init.Items.gunpowder });
    
        GameRegistry.addRecipe(new ItemStack(Items.grenadeCraftable, 16),
            new Object[] { " A ", "ABA", " A ", 'A', net.minecraft.init.Items.iron_ingot, 'B',
                    net.minecraft.init.Items.gunpowder });
    }
