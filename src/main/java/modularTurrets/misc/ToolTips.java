...
public class ToolTips {
	...
	public void onToolTip(ItemTooltipEvent event) {
		...
		if (event.itemStack.itemID == Blocks.turretBaseTierWood.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) woodTurretToolTip);
		}
		if (event.itemStack.itemID == Blocks.turretBaseTierOne.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) tierOneTurretToolTip);
		}
		if (event.itemStack.itemID == Blocks.turretBaseTierTwo.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) tierTwoTurretToolTip);
		}
		if (event.itemStack.itemID == Blocks.turretBaseTierThree.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) tierThreeTurretToolTip);
		}
		if (event.itemStack.itemID == Blocks.turretBaseTierFour.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) tierFourTurretToolTip);
		}
	
		if (event.itemStack.itemID == Blocks.disposableItemTurret.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) disposableItemTurretTooltip);
		}
		
		if (event.itemStack.itemID == Blocks.machineGunTurret.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) machineGunTurretTooltip);
		}
		
		if (event.itemStack.itemID == Blocks.grenadeLauncherTurret.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) grenadeTurretTooltip);
		}
		
		if (event.itemStack.itemID == Blocks.rocketTurret.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) rocketTurretTooltip);
		}
		
		if (event.itemStack.itemID == Blocks.laserTurret.blockID) {
			 event.toolTip.addAll((Collection<? extends String>) laserTurretTooltip);
		}
		
		if (event.itemStack.itemID == Items.fireRateUpgradeItem.itemID) {
			 event.toolTip.addAll((Collection<? extends String>) fireRateUpgradeTooltip);
		}
		
		if (event.itemStack.itemID == Items.efficiencyUpgradeItem.itemID) {
			 event.toolTip.addAll((Collection<? extends String>) efficiencyUpgradeTooltip);
		}
		
		if (event.itemStack.itemID == Items.rangeUpgradeItem.itemID) {
			 event.toolTip.addAll((Collection<? extends String>) rangeUpgradeTooltip);
		}
		
		if (event.itemStack.itemID == Items.accuraccyUpgradeItem.itemID) {
			 event.toolTip.addAll((Collection<? extends String>) accuraccyUpgradeTooltip);
		}
		
		if (event.itemStack.itemID == Items.solarPanelAddon.itemID) {
			 event.toolTip.addAll((Collection<? extends String>) solarPanelAddon);
		}
		
		if (event.itemStack.itemID == Items.redstoneReactorAddon.itemID) {
			 event.toolTip.addAll((Collection<? extends String>) redstoneReactorAddon);
		}
		
		if (event.itemStack.itemID == Items.damageAmpAddon.itemID) {
			 event.toolTip.addAll((Collection<? extends String>) damageAmpAddon);
		}
