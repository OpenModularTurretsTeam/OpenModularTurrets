...
public class TurretBaseTierWood extends BlockContainer {
    ...
    public TurretBaseTierWood(int par1) {
	super(par1, Material.rock);
	this.setUnlocalizedName(BlockNames.unlocalisedTurretBaseTierWood);
	...
	if (!world.isRemote) {
		...
		player.openGui(ModularTurrets.instance, 0, world, x, y, z);
	    } else {
