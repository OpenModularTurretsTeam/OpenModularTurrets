...
public class TurretBaseTierTwo extends BlockContainer {

    public final int MaxCharge = ConfigHandler.getBaseTierTwoMaxCharge();
    public final int MaxIO = ConfigHandler.getBaseTierTwoMaxIo();

    public TurretBaseTierTwo(int par1) {
	super(par1, Material.rock);
	this.setUnlocalizedName(BlockNames.unlocalisedTurretBaseTierTwo);
	...
	if (!world.isRemote) {
		...
		player.openGui(ModularTurrets.instance, 2, world, x, y, z);
	    } else {
