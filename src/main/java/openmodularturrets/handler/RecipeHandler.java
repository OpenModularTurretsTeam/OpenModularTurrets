...
public class RecipeHandler {
    ...
    public static void initRecipes() {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.turretBaseTierOne,
                                                   new Object[]{"ADA", "DCD", "ADA", 'A', "ingotLead", 'D', Items.ioBus,
                                                                'C', Items.sensorTierOneItem}));

        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.turretBaseTierWood, new Object[]{"ADA", "DCD", "ADA", 'A',
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Items.redstoneReactorAddon, new Object[]{"DDD", "DCD", "DAD", 'A',
                                                                                            net.minecraft.init.Items.redstone,
                                                                                            'D', "ingotLead", 'C',
                                                                                            "nuggetPlatinum"}));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.disposableItemTurret, new Object[]{"BCB", "CAC", " C ", 'C',
                                                                                             net.minecraft.init.Items.iron_ingot,
                                                                                             'B',
                                                                                             net.minecraft.init.Blocks.planks,
                                                                                             'A',
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.grenadeLauncherTurret,
                                                   new Object[]{"DBD", "BAB", " C ", 'C', Items.barrel, 'B',
                                                                "ingotInvar", 'A', Items.chamber, 'D', "dustLead"}));

        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.rocketTurret,
                                                   new Object[]{"BDB", "BAB", " C ", 'C', Items.barrel, 'B',
                                                                "ingotElectrum", 'A', Items.chamber, 'D',
                                                                "dustInvar"}));

        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.laserTurret,
                                                   new Object[]{"BDB", "BAB", " C ", 'C', Items.energeticBarrel, 'B',
                                                                "ingotEnderium", 'A', Items.containmentChamber, 'D',
                                                                "dustElectrum"}));

        GameRegistry.addRecipe(new ShapedOreRecipe(Blocks.railGunTurret,
                                                   new Object[]{"BAB", "BCB", " C ", 'C', Items.energeticBarrel, 'B',
                                                                "ingotInvar", 'A', Items.containmentChamber}));
        ...
        GameRegistry.addRecipe(new ItemStack(Items.ferroSlug, 16),
                               new Object[]{" A ", "CBC", " A ", 'A', net.minecraft.init.Items.iron_ingot, 'B',
