    ...
    public static void init() {
        ...
        GameRegistry
                .addRecipe(new ShapedOreRecipe(new ItemStack(
                        ...
                        "ECE", "ADA", 'A', "ingotLead", 'B', cellBasic, 'C',
                        Items.sensorTierTwoItem, 'D', powerCoilGold, 'E',
                        Items.ioBus}));
        ...
        GameRegistry
                .addRecipe(new ShapedOreRecipe(new ItemStack(
                        ...
                        "ECE", "ADA", 'A', "ingotLead", 'B', cellBasic, 'C',
                        net.minecraft.init.Blocks.redstone_block, 'D', powerCoilGold, 'E',
                        Items.ioBus}));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                Blocks.expanderPowerTierThree, 1),
                new Object[]{"ABA", "ECE", "ADA", 'A', "ingotInvar", 'B',
                        cellHardened, 'C', net.minecraft.init.Blocks.redstone_block, 'D',
                        powerCoilGold, 'E', Items.ioBus}));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                Blocks.expanderPowerTierFour, 1),
                new Object[]{"ABA", "ECE", "ADA", 'A', "ingotElectrum", 'B',
                        cellReinforced, 'C', net.minecraft.init.Blocks.redstone_block, 'D',
                        powerCoilGold, 'E', Items.ioBus}));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                Blocks.expanderPowerTierFive, 1), new Object[]{"ABA", "ECE",
                "ADA", 'A', net.minecraft.init.Blocks.obsidian, 'B',
                cellResonant, 'C', net.minecraft.init.Blocks.redstone_block, 'D',
                powerCoilGold, 'E', Items.ioBus}));
        ...
        GameRegistry
                .addRecipe(new ShapedOreRecipe(new ItemStack(
                        ...
                        "ECE", "ADA", 'A', "ingotLead", 'B', cellBasic, 'C',
                        net.minecraft.init.Blocks.chest, 'D', powerCoilGold, 'E',
                        Items.ioBus}));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                ...
                new Object[]{"ABA", "ECE", "ADA", 'A', "ingotElectrum", 'B',
                        cellReinforced, 'C', net.minecraft.init.Blocks.chest, 'D',
                        powerCoilGold, 'E', Items.ioBus}));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                Blocks.expanderInvTierFive, 1), new Object[]{"ABA", "ECE",
                "ADA", 'A', net.minecraft.init.Blocks.obsidian, 'B',
                cellResonant, 'C', net.minecraft.init.Blocks.chest, 'D',
                powerCoilGold, 'E', Items.ioBus}));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                ...
                'A', "ingotLead", 'B', net.minecraft.init.Items.gunpowder, 'C',
                "ingotIron"}));
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                ...
                "ingotInvar", 'B', net.minecraft.init.Items.flint, 'C',
                net.minecraft.init.Items.redstone}));
    }
}
