    ...
    public static void init() {
        ...
        GameRegistry
                .addRecipe(new ShapedOreRecipe(new ItemStack(
                        ...
                        "ECE", "ADA", 'A', "ingotElectricalSteel", 'B', capacitorBank, 'C',
                        net.minecraft.init.Blocks.redstone_block, 'D', basicCapacitor, 'E',
                        Items.ioBus}));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                Blocks.expanderPowerTierThree, 1),
                new Object[]{"ABA", "ECE", "ADA", 'A', "ingotDarkSteel", 'B',
                        capacitorBank, 'C', net.minecraft.init.Blocks.redstone_block, 'D',
                        basicCapacitor, 'E', Items.ioBus}));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                Blocks.expanderPowerTierFour, 1),
                new Object[]{"ABA", "ECE", "ADA", 'A', "ingotSoularium", 'B',
                        capacitorBankVibrant, 'C', net.minecraft.init.Blocks.redstone_block, 'D',
                        doubleCapacitor, 'E', Items.ioBus}));
        ...
        GameRegistry
                .addRecipe(new ShapedOreRecipe(new ItemStack(
                        ...
                        "ECE", "ADA", 'A', "ingotElectricalSteel", 'B', capacitorBank, 'C',
                        net.minecraft.init.Blocks.chest, 'D', basicCapacitor, 'E',
                        Items.ioBus}));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                Blocks.expanderInvTierThree, 1),
                new Object[]{"ABA", "ECE", "ADA", 'A', "ingotDarkSteel", 'B',
                        capacitorBank, 'C', net.minecraft.init.Blocks.chest, 'D',
                        basicCapacitor, 'E', Items.ioBus}));

        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                Blocks.expanderInvTierFour, 1),
                new Object[]{"ABA", "ECE", "ADA", 'A', "ingotSoularium", 'B',
                        capacitorBankVibrant, 'C', net.minecraft.init.Blocks.chest, 'D',
                        doubleCapacitor, 'E', Items.ioBus}));
