...
class ExpanderPowerTierThreeItemRenderer implements IItemRenderer {
    ...
    public ExpanderPowerTierThreeItemRenderer(ExpanderPowerTierThreeRenderer expanderPowerTierThreeRenderer,
            ExpanderPowerTierThreeTileEntity expanderPowerTierThreeTileEntity) {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        this.expanderPowerTierThreeRenderer
                .renderTileEntityAt(this.expanderPowerTierThreeTileEntity, 0.1D, 0.1D, -0.2D, 0.0F);
        GL11.glPopMatrix();
    }
}
