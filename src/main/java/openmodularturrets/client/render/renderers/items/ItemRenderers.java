...
public class ItemRenderers {
    public static void init() {
        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.disposableItemTurret),
                                                  new DisposableItemTurretItemRenderer(
                                                          TileEntityRenderers.disposableItemTurretRenderer,
                                                          new DisposableItemTurretTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.potatoCannonTurret),
                                                  new PotatoCannonTurretItemRenderer(
                                                          TileEntityRenderers.potatoCannonTurretRenderer,
                                                          new PotatoCannonTurretTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.rocketTurret),
                                                  new RocketTurretItemRenderer(TileEntityRenderers.rocketTurretRenderer,
                                                                               new RocketTurretTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.machineGunTurret),
                                                  new MachineGunTurretItemRenderer(
                                                          TileEntityRenderers.machineGunTurretRenderer,
                                                          new GunTurretTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.grenadeLauncherTurret),
        ...
        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.laserTurret),
                                                  new LaserTurretItemRenderer(TileEntityRenderers.laserTurretRenderer,
                                                                              new LaserTurretTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.leverBlock),
                                                  new LeverItemRenderer(TileEntityRenderers.leverRenderer,
                                                                        new LeverTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.railGunTurret),
                                                  new RailGunTurretItemRenderer(
                                                          TileEntityRenderers.railGunTurretRenderer,
                                                          new RailGunTurretTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.incendiaryTurret),
                                                  new IncendiaryTurretItemRenderer(
                                                          TileEntityRenderers.incendiaryTurretRenderer,
                                                          new IncendiaryTurretTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.relativisticTurret),
                                                  new RelativisticTurretItemRenderer(
                                                          TileEntityRenderers.relativisticTurretRenderer,
                                                          new RelativisticTurretTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.teleporterTurret),
                                                  new TeleporterTurretItemRenderer(
                                                          TileEntityRenderers.teleporterTurretRenderer,
                                                          new TeleporterTurretTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.expanderPowerTierOne),
                                                  new ExpanderPowerTierOneItemRenderer(
                                                          TileEntityRenderers.expanderPowerTierOneRenderer,
                                                          new ExpanderPowerTierOneTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.expanderPowerTierTwo),
                                                  new ExpanderPowerTierTwoItemRenderer(
                                                          TileEntityRenderers.expanderPowerTierTwoRenderer,
                                                          new ExpanderPowerTierTwoTileEntity()));

        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.expanderPowerTierThree),
        ...
        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.expanderPowerTierFour),
        ...
        MinecraftForgeClient.registerItemRenderer(Item.getItemFromBlock(Blocks.expanderPowerTierFive),
