...
class ExpanderPowerTierTwoItemRenderer implements IItemRenderer {
    ...
    public ExpanderPowerTierTwoItemRenderer(ExpanderPowerTierTwoRenderer expanderPowerTierTwoRenderer, ExpanderPowerTierTwoTileEntity expanderPowerTierTwoTileEntity) {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        this.expanderPowerTierTwoRenderer.renderTileEntityAt(this.expanderPowerTierTwoTileEntity, 0.1D, 0.1D, -0.2D,
                                                             0.0F);
        GL11.glPopMatrix();
    }
}
