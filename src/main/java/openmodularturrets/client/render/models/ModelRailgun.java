...
public class ModelRailgun extends ModelBase {
	...
	public ModelRailgun() {
		...
		BarrelTop.setRotationPoint(0F, 16F, 0F);
		...
		BarrelBot.setRotationPoint(0F, 16F, 0F);
		...
		BarrelRight.setRotationPoint(0F, 16F, 0F);
		...
		BarrelLeft.setRotationPoint(0F, 16F, 0F);
		...
		RightGuard.setRotationPoint(0F, 16F, 0F);
		...
		LeftGuard.setRotationPoint(0F, 16F, 0F);
		...
		GuardBinder.setRotationPoint(0F, 16F, 0F);
