...
public class ModelGrenadeLauncher extends ModelBase {
	...
	public ModelGrenadeLauncher() {
		...
		Barrel.addBox(-2F, -4F, -8F, 4, 4, 12);
		Barrel.setRotationPoint(0F, 16F, 0F);
		Barrel.setTextureSize(64, 64);
		Barrel.mirror = true;
		setRotation(Barrel, 0F, 0F, 0F);
		Chamber = new ModelRenderer(this, 35, 20);
		Chamber.addBox(-3F, -5F, 3F, 6, 6, 6);
		Chamber.setRotationPoint(0F, 16F, 0F);
		Chamber.setTextureSize(64, 64);
		Chamber.mirror = true;
		setRotation(Chamber, 0F, 0F, 0F);
		Shape1 = new ModelRenderer(this, 0, 5);
		Shape1.addBox(-1F, -6F, -7F, 2, 2, 4);
