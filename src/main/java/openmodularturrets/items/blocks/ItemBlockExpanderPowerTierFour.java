...
public class ItemBlockExpanderPowerTierFour extends ItemBlock {

    public ItemBlockExpanderPowerTierFour(Block p_i45328_1_) {
        super(p_i45328_1_);
    }
    ...
    public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
        ...
        p_77624_3_.add(
                EnumChatFormatting.WHITE + StatCollector.translateToLocal("tooltip.expander.power2")
                        + " "
                        + ConfigHandler.getExpanderPowerTierFourCapacity()
                        + " "
