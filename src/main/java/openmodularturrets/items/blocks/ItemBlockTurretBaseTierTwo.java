...
public class ItemBlockTurretBaseTierTwo extends ItemBlock {
    ...
    public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
        ...
        p_77624_3_.add(StatCollector.translateToLocal("tooltip.rf.max") + ": " + EnumChatFormatting.WHITE + ConfigHandler.getBaseTierTwoMaxCharge());
        p_77624_3_.add(StatCollector.translateToLocal("tooltip.rf.io") + ": " + EnumChatFormatting.WHITE + ConfigHandler.getBaseTierTwoMaxIo());
        p_77624_3_.add("");
