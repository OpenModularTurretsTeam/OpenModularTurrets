...
public class ConcealerAddonItem extends AddonItem {
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ModInfo.ID.toLowerCase() + ":concealerAddon");
    }
    ...
    public void addInformation(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List p_77624_3_, boolean p_77624_4_) {
        ...
        p_77624_3_.add("");
        p_77624_3_.add(StatCollector.translateToLocal("turret.addon.concealer.1"));
        p_77624_3_.add("");
        p_77624_3_.add(EnumChatFormatting.DARK_GRAY + StatCollector.translateToLocal("turret.addon.concealer.flavour"));
    }
}
