	...
	public void randomDisplayTick(World p_149734_1_, int p_149734_2_,
		...
		if (shouldAnimate) {
			for (int i = 0; i <= 25; i++) {
				...
				p_149734_1_.spawnParticle("portal", p_149734_2_ + 0.5f
						+ p_149734_5_.nextGaussian(), p_149734_3_ + 0.5f
						+ p_149734_5_.nextGaussian(), p_149734_4_ + 0.5f
						+ p_149734_5_.nextGaussian(), (double) var21,
