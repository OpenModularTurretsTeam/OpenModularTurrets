...
public class BlockExpanderInvTierTwo extends BlockContainer {
    public BlockExpanderInvTierTwo() {
        super(Material.rock);
        this.setCreativeTab(ModularTurrets.modularTurretsTab);
        this.setResistance(3.0F);
        this.setStepSound(Block.soundTypeStone);
        this.setBlockName(Names.Blocks.unlocalisedExpanderInvTierTwo);
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        blockIcon = p_149651_1_.registerIcon(ModInfo.ID.toLowerCase() + ":expanderInvTierTwo");
    }
    ...
    public TileEntity createNewTileEntity(World world, int par2) {
        return new ExpanderInvTierTwoTileEntity();
    }
