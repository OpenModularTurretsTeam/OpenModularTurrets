...
public class BlockExpanderInvTierFive extends BlockContainer {
    public BlockExpanderInvTierFive() {
        super(Material.rock);
        this.setCreativeTab(ModularTurrets.modularTurretsTab);
        this.setResistance(3.0F);
        this.setStepSound(Block.soundTypeStone);
        this.setBlockName(Names.Blocks.unlocalisedExpanderInvTierFive);
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        blockIcon = p_149651_1_.registerIcon(ModInfo.ID.toLowerCase() + ":expanderInvTierFive");
    }
    ...
    private void dropItems(World world, int x, int y, int z) {
        if (world.getTileEntity(x, y, z) instanceof ExpanderInvTierFiveTileEntity) {
            ExpanderInvTierFiveTileEntity entity = (ExpanderInvTierFiveTileEntity) world.getTileEntity(x, y, z);
