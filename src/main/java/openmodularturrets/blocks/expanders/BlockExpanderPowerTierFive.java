...
public class BlockExpanderPowerTierFive extends BlockAbstract implements ITileEntityProvider {
    public BlockExpanderPowerTierFive() {
        super(Material.rock);
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        blockIcon = p_149651_1_.registerIcon(ModInfo.ID.toLowerCase() + ":expanderPowerTierFive");
    }

    @Override
    public TileEntity createNewTileEntity(World world, int par2) {
        return new ExpanderPowerTierFiveTileEntity();
    }
