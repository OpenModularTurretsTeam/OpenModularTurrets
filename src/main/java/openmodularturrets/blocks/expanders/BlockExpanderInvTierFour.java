...
public class BlockExpanderInvTierFour extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        ...
        blockIcon = p_149651_1_.registerIcon(ModInfo.ID.toLowerCase() + ":expanderInvTierFour");
    }
    ...
    private void dropItems(World world, int x, int y, int z) {
        if (world.getTileEntity(x, y, z) instanceof ExpanderInvTierFourTileEntity) {
            ExpanderInvTierFourTileEntity entity = (ExpanderInvTierFourTileEntity) world.getTileEntity(x, y, z);
