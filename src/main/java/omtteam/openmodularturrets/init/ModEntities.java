...
public class ModEntities {
    public static void registerProjectiles(OpenModularTurrets mod) {
        ...
        EntityRegistry.registerModEntity(new ResourceLocation(Reference.MOD_ID + ":laserProjectile"), LaserProjectile.class, Reference.MOD_ID + ":laserProjectile", 4, mod, 64, 64, true);
