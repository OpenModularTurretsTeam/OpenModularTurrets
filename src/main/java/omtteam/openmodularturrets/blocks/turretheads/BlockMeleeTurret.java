...
import omtteam.openmodularturrets.items.blocks.ItemBlockMeleeTurret;
import omtteam.openmodularturrets.reference.OMTNames;
import omtteam.openmodularturrets.reference.Reference;
import omtteam.openmodularturrets.tileentity.turrets.MeleeTurretTileEntity;
...
public class BlockMeleeTurret extends BlockAbstractTurretHead {
    public BlockMeleeTurret() {
        super();
        this.setUnlocalizedName(OMTNames.Blocks.meleeTurret);
        this.setRegistryName(Reference.MOD_ID, OMTNames.Blocks.meleeTurret);
    }

    @Override
    public ItemBlock getItemBlock(Block block) {
        return new ItemBlockMeleeTurret(block);
    }
    ...
    public TileEntity createTileEntity_OM(World world, IBlockState state) {
        return new MeleeTurretTileEntity();
    }
    ...
    public TurretType getTurretType() {
        return TurretList.getTurretType(OMTNames.Blocks.meleeTurret);
    }
}
