...
public class ItemBlockTeleporterTurret extends ItemBlock {
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer player, List tooltip, boolean advanced) {
        ...
        tooltip.add("");
        tooltip.add(TextFormatting.DARK_GRAY + I18n.translateToLocal("flavour.turret.9a"));
        tooltip.add(TextFormatting.DARK_GRAY + I18n.translateToLocal("flavour.turret.9b"));
    }
}
