...
public class ItemBlockDisposableTurret extends AbtractItemBlockBaseAddon {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(safeLocalize("tooltip.range") + ": " + TextFormatting.WHITE +
                OMTConfigHandler.getDisposableTurretSettings().getRange());
        ...
        tooltip.add(safeLocalize("tooltip.damage.stat") + ": " + TextFormatting.WHITE +
                (OMTConfigHandler.getDisposableTurretSettings().getDamage() / 2F) + " " + safeLocalize(
                "tooltip.health"));
        ...
        tooltip.add(safeLocalize("tooltip.fire_rate") + ": " + TextFormatting.WHITE + df.format(
                20.0F / OMTConfigHandler.getDisposableTurretSettings().getFireRate()));
        tooltip.add(safeLocalize("tooltip.energy.stat") + ": " + TextFormatting.WHITE +
                OMTConfigHandler.getDisposableTurretSettings().getPowerUsage() + " RF");
        tooltip.add("");
