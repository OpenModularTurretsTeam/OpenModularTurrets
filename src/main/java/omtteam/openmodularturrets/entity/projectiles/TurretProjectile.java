...
public abstract class TurretProjectile extends EntityThrowable {
    ...
    public void onUpdate() {
        ...
        List<Entity> list = this.getEntityWorld().getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().addCoord(this.motionX, this.motionY, this.motionZ).expandXyz(0.2D));
        ...
        float f = MathTools.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
