package omtteam.openmodularturrets.capabilities;
 ...
 * optional.
 */
public class BaseOMTTeslaContainer implements ITeslaConsumer, ITeslaProducer, ITeslaHolder {
     ...
     */
    public BaseOMTTeslaContainer() {

        this(50000, 1000, 1000);
    }
     ...
     */
    public BaseOMTTeslaContainer(long capacity, long input, long output) {
     ...
     * @param output The maximum rate of power that can be extracted at a time.
     */
    public BaseOMTTeslaContainer(long power, long capacity, long input, long output) {
     ...
     */
    public BaseOMTTeslaContainer(NBTTagCompound dataTag) {
     ...
     */
    public BaseOMTTeslaContainer setCapacity (long capacity) {
     ...
     * @return The instance of the container being updated.
     */
    public BaseOMTTeslaContainer setInputRate (long rate) {
     ...
     * @return The instance of the container being updated.
     */
    public BaseOMTTeslaContainer setOutputRate (long rate) {
     ...
     * @return The instance of the container being updated.
     */
    public BaseOMTTeslaContainer setTransferRate (long rate) {
