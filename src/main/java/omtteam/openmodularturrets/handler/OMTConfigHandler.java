...
public class OMTConfigHandler {
    ...
    private static int baseTierOneMaxTurrets;
    ...
    private static int baseTierTwoMaxTurrets;
    ...
    private static int baseTierThreeMaxTurrets;
    ...
    private static int baseTierFourMaxTurrets;
    ...
    private static int baseTierFiveMaxTurrets;
    ...
    public static void init(File configFile) {
        ...
        baseTierOneMaxTurrets = config.get("TurretBaseTierOne", "MaxTurrets", 1).getInt();
        ...
        baseTierTwoMaxTurrets = config.get("TurretBaseTierTwo", "MaxTurrets", 1).getInt();
        ...
        baseTierThreeMaxTurrets = config.get("TurretBaseTierThree", "MaxTurrets", 2).getInt();
        ...
        baseTierFourMaxTurrets = config.get("TurretBaseTierFour", "MaxTurrets", 3).getInt();
        ...
        baseTierFiveMaxTurrets = config.get("TurretBaseTierFive", "MaxTurrets", 4).getInt();
        ...
        disposable_turret = new TurretSetting(
                ...
                config.get("TurretDisposable", "MaxSimultaneous", 4,
                           "How many of these can be attached to one base?").getInt());
        ...
        potato_cannon_turret = new TurretSetting(
                ...
                config.get("TurretPotatoCannon", "DamageAmpBonus", 0.05F,
                           "Value of the bonus damage (relative to HP of enemy target) per damage amp addon.").getDouble(),
                config.get("TurretPotatoCannon", "MaxSimultaneous", 4,
                           "How many of these can be attached to one base?").getInt());
        ...
        machine_gun_turret = new TurretSetting(config.get("TurretMachineGun", "Range", 18, "Turret range, in blocks").getInt(),
                                               ...
                                               config.get("TurretMachineGun", "DamageAmpBonus", 0.06F,
                                                          "Value of the bonus damage (relative to HP of enemy target) per damage amp addon.").getDouble(),
                                               config.get("TurretMachineGun", "MaxSimultaneous", 4,
                                                          "How many of these can be attached to one base?").getInt());
        ...
        incendiary_turret = new TurretSetting(
                ...
                config.get("TurretIncendiary", "DamageAmpBonus", 0.05F,
                           "Value of the bonus damage (relative to HP of enemy target) per damage amp addon.").getDouble(),
                config.get("TurretIncendiary", "MaxSimultaneous", 4,
                           "How many of these can be attached to one base?").getInt());
        ...
        grenade_turret = new TurretSetting(config.get("TurretGrenade", "Range", 20, "Turret range, in blocks").getInt(),
                                           ...
                                           config.get("TurretGrenade", "DamageAmpBonus", 0.08F,
                                                      "Value of the bonus damage (relative to HP of enemy target) per damage amp addon.").getDouble(),
                                           config.get("TurretGrenade", "MaxSimultaneous", 3,
                                                      "How many of these can be attached to one base?").getInt());
        ...
        relativistic_turret = new TurretSetting(
                ...
                config.get("TurretRocket", "MaxSimultaneous", 4,
                           "How many of these can be attached to one base?").getInt());
        ...
        rocket_turret = new TurretSetting(config.get("TurretRocket", "Range", 30, "Turret range, in blocks").getInt(),
                                          ...
                                          config.get("TurretRocket", "DamageAmpBonus", 0.08F,
                                                     "Value of the bonus damage (relative to HP of enemy target) per damage amp addon.").getDouble(),
                                          config.get("TurretRocket", "MaxSimultaneous", 3,
                                                     "How many of these can be attached to one base?").getInt());
        ...
        teleporter_turret = new TurretSetting(
                ...
                config.get("TurretTeleporter", "Enabled", true, "Enabled?").getBoolean(), 0, 1);
        ...
        laser_turret = new TurretSetting(config.get("TurretLaser", "Range", 25, "Turret range, in blocks").getInt(),
                                         ...
                                         config.get("TurretLaser", "DamageAmpBonus", 0.06F,
                                                    "Value of the bonus damage (relative to HP of enemy target) per damage amp addon.").getDouble(),
                                         config.get("TurretLaser", "MaxSimultaneous", 4,
                                                    "How many of these can be attached to one base?").getInt());
        ...
        railgun_turret = new TurretSetting(config.get("TurretRailgun", "Range", 30, "Turret range, in blocks").getInt(),
                                           ...
                                           config.get("TurretRailgun", "DamageAmpBonus", 0.10F,
                                                      "Value of the bonus damage (relative to HP of enemy target) per damage amp addon.").getDouble(),
                                           config.get("TurretRailgun", "MaxSimultaneous", 2,
                                                      "How many of these can be attached to one base?").getInt());
    ...
    public static int getBaseTierOneMaxTurrets() {
        return baseTierOneMaxTurrets;
    }

    public static int getBaseTierTwoMaxTurrets() {
        return baseTierTwoMaxTurrets;
    }

    public static int getBaseTierThreeMaxTurrets() {
        return baseTierThreeMaxTurrets;
    }

    public static int getBaseTierFourMaxTurrets() {
        return baseTierFourMaxTurrets;
    }

    public static int getBaseTierFiveMaxTurrets() {
        return baseTierFiveMaxTurrets;
    }
    ...
    public static class TurretSetting {
        ...
        private TurretSetting(int range, int rof, int damage, double accuracy, int power_usage, boolean enabled, double damage_amp, int max_simultaneous) {
            this.range = range;
            this.fireRate = rof;
            this.damage = damage;
