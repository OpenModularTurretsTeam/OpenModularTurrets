...
public class ModelDisposableItemTurret extends ModelAbstractTurret {
    ...
    public ModelDisposableItemTurret() {
        ...
        holder.cubeList.add(new ModelBox(holder, 0, 19, -4.0F, 3.0F, -4.0F, 8, 1, 8, 0.0F, true));
        ...
        BoxLeft_r1.cubeList.add(new ModelBox(BoxLeft_r1, 0, 19, -12.0F, 4.0F, -4.0F, 8, 1, 8, 0.0F, true));
        BoxLeft_r1.cubeList.add(new ModelBox(BoxLeft_r1, 0, 19, -12.0F, -5.0F, -4.0F, 8, 1, 8, 0.0F, true));

        weapon = new ModelRenderer(this);
        weapon.setRotationPoint(0.0F, 0.0F, 0.0F);
        holder.addChild(weapon);
        weapon.cubeList.add(new ModelBox(weapon, 20, 0, -2.0F, -3.0F, -12.0F, 4, 4, 14, 0.0F, true));
    }
