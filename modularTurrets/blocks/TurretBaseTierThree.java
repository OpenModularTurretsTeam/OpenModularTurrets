...
public class TurretBaseTierThree extends BlockContainer {
    ...
    public TurretBaseTierThree(int par1) {
	super(par1, Material.rock);
	this.setUnlocalizedName(BlockNames.unlocalisedTurretBaseTierThree);
	...
	if (!world.isRemote) {
		...
		player.openGui(ModularTurrets.instance, 3, world, x, y, z);
	    } else {
