...
public class ShootingEntityLaser extends EntityLiving implements
	IRangedAttackMob {
	...
	LaserProjectile entityCrap = new LaserProjectile(worldObj, posX,
		posY + 1.8F, posZ, entitylivingbase);

	if (TurretHeadUtils.hasDamageAmpAddon(base)) {
	    worldObj.playSoundEffect(posX, posY, posZ, "modularturrets:amped",
		    1.0F, 1.0F);
	...
	worldObj.playSoundEffect(posX, posY, posZ, "modularturrets:laser",
		0.5F, 1.0F);
