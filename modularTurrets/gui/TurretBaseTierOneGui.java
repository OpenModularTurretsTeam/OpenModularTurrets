...
public class TurretBaseTierOneGui extends GuiContainer {
	...
	this.base = (TurretBaseTierOneTileEntity) tileEntity;
    }
	...
	if (base.storage != null
		&& base.getMaxEnergyStored(ForgeDirection.UNKNOWN) > 0) {
	    ResourceLocation texture = (new ResourceLocation(ModInfo.ID
		    + ":textures/gui/baseInvTier1.png"));
	    ...
	    drawTexturedModalRect(x + 153, y + 17 + 51 - expression, 196, 17,
		    14, expression);
	}
    }
